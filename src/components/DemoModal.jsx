    ...
    <div className="demo-modal-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="demo-modal-screen-container">
          <div className="demo-arcade-cabinet">
            <div className="demo-arcade-header">
              <span>{game.name.toUpperCase()} SYSTEM</span>
              <div className="demo-arcade-header-status">
                <span className={`demo-status-dot ${gameState === 'playing' ? 'pulsing' : ''}`} />
                <span>{gameState === 'playing' ? 'LIVE EMULATOR' : 'CABINET CONNECTED'}</span>
              </div>
            </div>

            <div className="demo-arcade-screen">
              <div className="demo-screen-glow" />

              {gameState === 'idle' && (
                <div className="demo-screen-idle">
                  <h3 className="demo-arcade-logo">{game.name}</h3>
                  <p className="demo-arcade-sub">Direct Cabinet Preview Emulation</p>
                  <p className="demo-insert-coin">INSERT COIN</p>
              ...
              {gameState === 'gameover' && (
                <div className="demo-screen-gameover">
                  <h3 className="demo-gameover-title">SESSION COMPLETE</h3>
                  <span className="demo-gameover-score-lbl">Demo Score</span>
                  <span className="demo-gameover-score-val">{score}</span>
                  <div className="demo-gameover-actions">
                    <button className="demo-btn-retry" onClick={startGame}>
                      RELOAD DEMO
                    </button>
                  </div>
                </div>
